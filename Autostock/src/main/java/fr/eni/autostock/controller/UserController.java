...
public class UserController {
	...
	public String signup(Model model, RedirectAttributes redirectAttrs, @ModelAttribute("user")
			@RequestParam(required = true) String gender,@RequestParam(required = true) String lastName,
			@RequestParam(required = true) String firstName, @RequestParam(required = true) String email,
			@RequestParam(required = true) String phone, @RequestParam(required = true) String password, 
			@RequestParam(required = true) String confirmPassword, @RequestParam(required = true) String adresse,
			@RequestParam(required = true) String codePostal, @RequestParam(required = true) String city) {
		...
		if(password.equals(confirmPassword))
		{
			...
			//model.addAttribute("msgInscriptionOK", "Vous êtes désormais inscrit sur le site.");
