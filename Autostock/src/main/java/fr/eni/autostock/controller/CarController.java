...
public class CarController {
	...
	@PostMapping("/add")
	public String saveVehiculeRoute(@ModelAttribute("car") @RequestParam(required = true) String brand,
			...
			@RequestParam(required = false) Long opt1, 
			@RequestParam(required = false) Long opt2,
			@RequestParam(required = false) Long opt3,
			@RequestParam(required = false) Long opt4) {
	...
	@PostMapping("/panier")
	public String ajouterPanier(Model model, HttpSession session,
			@RequestParam(required = true) String marque, 
